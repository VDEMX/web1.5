 ...
 <section id="container">
 	...
 	<h2 class="titulo">Nuevos productos</h2>
			...
			<ul class="grid cs-style-4">
				<li>
					<figure>
						<div><img src="images/np-waterdrive.jpg" alt="WATER DRIVE"></div>
						<figcaption>
							<h3>Water Drive</h3>
							<span>Variador de frecuencia</span>
							<img src="images/logo-hc.png" alt="HidroControl">
							<a href="/waterdrive"><div class="icon icon-ojo"></div> Ver producto</a>
						</figcaption>
					</figure>
				</li>
				<li>
				...
				<li>
					<figure>
						<div><img src="images/np-job.jpg" alt="DIVA"></div>
						<figcaption>
							<h3>Job</h3>
				...
				<li>
					<figure>
						<div><img src="images/np-diva.jpg" alt="DIVA"></div>
						<figcaption>
							<h3>Diva</h3>
				...
				<li>
					<figure>
						...
						<figcaption>
							...
							<img src="images/logo-hc.png" alt="HidroControl">
							<a href="http://vde.com.mx/procontrol"><div class="icon icon-ojo"></div> Ver producto</a>
						</figcaption>
					</figure>
				</li>
				<li>
				...
				<li>
					<figure>
						...
						<figcaption>
							<h3>Etapa 2 <span class="blanco">Sanitiza</span></h3>
