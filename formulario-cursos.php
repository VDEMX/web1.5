...
<?php include("head.php"); ?>
 ...
 <section id="container">
 	...
 	<section>
	 	<a href="/curso-hermosillo"><button class="button">Hermosillo</button></a>	 	
	 	<span>14-16 de Noviembre <strong class="rojo">($1,300 + IVA)</strong></span>
 	</section>
 	<section>
	 	<a href="/curso-cancun"><button class="button">Cancún</button></a>
	 	<span>5-7 de Diciembre <strong class="rojo">($1,300 + IVA)</strong></span>
 	</section>
 	<!-- <section>
	 	<button class="button">Curso en línea</button>
	 	<span>  1,2,8,9 de Noviembre <strong class="rojo">(Gratuito)</strong></span>
 	</section>-->
