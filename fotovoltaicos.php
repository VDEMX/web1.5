            ...
            <div role="navigation">
                ...
                <div class="content">
                	<div id="box1" class="active box">
                	   <img src="images/sis-fotovoltaicos_03.jpg" alt="sis-fotovoltaicos_03">
						<img src="images/sis-fotovoltaicos_05.jpg" alt="sis-fotovoltaicos_05">
                	...
                	<h2>MÓDULO SOLAR</h2>
                	<img src="images/sis-fot-mod_03.jpg" alt="sis-fot-mod_03">
					<img src="images/sis-fot-mod_05.jpg" alt="sis-fot-mod_05">
					<h2>APLICACIONES</h2>
					<img src="images/sis-fot-mod_08.jpg" alt="sis-fot-mod_08" class="tres-col">
                	...
                	<h3>(Próximamente)</h3>
                	<img src="images/sis-fot-inv_09.jpg" alt="sis-fot-inv_03">
                	...
                	<h2>ACCESORIOS</h2>
                	<h3>CABLE CONECTOR MC4</h3>
                	<hr>
                	<section class="p40">
	                	<p>El cable MC4 es un cable de extensión aislado con polietileno resistente a la humedad, a los rayos del sol y al calor. Tiene retardante de flama y es el cable que provee la máxima seguridad cuando se trabaja con sistemas solares fotovoltaicos. Descripción: 10 AWG cobre desnudo, 600V, Aislamiento XLPE con chaqueta de PVC. </p>
	                	<img src="images/cables-mc4.jpg" alt="cable">
	                	
                	</section>
                	
                	<section class="p60">
	                	<img src="images/cable-esp.gif" alt="Especificaciones">
	                	<p>Impresión a inyección de tinta de la marca secuencial de metros en la chaqueta del cable. Cumple con el ROHS</p>
                	</section>
                	
                	<h3>CONECTORES HEMBRA Y MACHO MC4</h3>
                	<hr>
                	<p>Los conectores MC4 proporcionan un medio resistente al agua para realizar las conexiones eléctricas entre los paneles solares
y el cable de extensión MC4. </p>
                	<section class="p40">
                	...
                	<section class="p60">
	                	<img src="images/pin-esp.gif" alt="Especificaciones">
                	</section>

                	<section class="p100">
	                	<h3>INTERRUPTOR TERMOMÁGNETICO</h3>
                	<hr>
                	<section class="p40">
                		<img src="images/interruptor-termomagnetico.jpg" alt="interruptor">
                	</section>
                	<section class="p60">
	                	<img src="images/esp-fv-01.png" alt="Especificaciones">
                	</section>
	                <p>Interruptor termomágnetico de 3 polos para la interrupción total de los sistemas eléctricos de corriente alterna.</p>
                	</section>
                	
                	<h3>SUPRESOR DE PICOS DE CORRIENTE DIRECTA</h3>
                	<hr>
                	<section class="p40">
                		<img src="images/supresor-picos-corriente-directa.jpg" alt="supresor">
                	</section>
                	<section class="p60">
	                	<img src="images/esp-fv-02.png" alt="Especificaciones">
                	</section>
	                <p>Protección de corriente directa para sistemas de energía solar contra sobretensiones y picos de voltaje. El supresor de picos de corriente directa maneja  una protección muy alta para canalizar picos de corriente a tierra sin causar daños.                                                                                                                                                 Si bien no es posible lograr una protección del 100%  contra descarga de rayos el supresor de picos de corriente directa reduce en gran medida los problemas debido a los rayos, sobretensiones y picos de voltaje. </p>
	                
	                <h3>SUPRESOR DE PICOS DE CORRIENTE ALTERNA MONOFÁSICO Y TRIFÁSICO</h3>
                	<hr>
                	<section class="p60">
                		<img src="images/supresor-picos-corriente-alterna.jpg" alt="supresor">
                	</section>
                	<section class="p40">
				...
				<div class="custom-header clearfix">
					...
					<nav>
						...
						<span id="custom-current" class="custom-current" title="ir a la fecha actual"></span>
					</nav>
				</div>
				<div id="calendar" class="fc-calendar-container"></div>
                  ...
                  <article>
                  <h2>Introducción y Dimensionamiento de Sistemas Fotovoltaicos.</h2>
                  <p>
	                  <strong>Curso Básico</strong>
						<ul>
							<li>Introducción a la energía renovable fotovoltaica.</li>
							<li>El sistema fotovoltaico</li>
							<li>Módulo Solar</li>
							<li>Celda Solar</li>
							<li>Sistema Aislado					 </li>
							<li>Sistema de Interconexión		 </li>
							<li>El Inversor						 </li>
							<li>Medidor Bidireccional			 </li>
							<li>Garantías y Mantenimiento		 </li>
							<li>Conceptos Eléctricos			 </li>
							<li>CFE								 </li>
							<li>Financiamiento FIDE				 </li>
							<li>Conceptos Solares				 </li>
							<li>Orientación y Posición de Paneles</li>
							<li>Eficiencia de un Panel			 </li>
							<li>Especificaciones del Panel		 </li>
							<li>Especificaciones del Inversor	 </li>
							<li>Generación de Energía			 </li>
							<li>Cálculo de Generación			 </li>
							<li>Caso Práctico					 </li>
						</ul>
						<img src="images/panel_fv.png" alt="panel_fv">
                  </p>
                  </article>
                  <article>
                  <p>	
						<strong>Curso de Instalación</strong>
						<ul>
							<li>Comportamiento de la Irradiación Solar</li>
							<li>Capacidad del sistema fotovoltaico	  </li>
							<li>Dimensionamiento de las series		  </li>
							<li>Montaje en techos planos			  </li>
							<li>Montaje en techos inclinados		  </li>
							<li>Tipos de Inversores				      </li>
							<li>Sistemas en Isla					  </li>
							<li>Baterías							  </li>
							<li>Instalación Inversor				  </li>
							<li>Medidor Bidireccional				  </li>
