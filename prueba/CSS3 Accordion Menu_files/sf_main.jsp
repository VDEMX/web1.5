...
, 
    ...
    get: function(im) {
        ...
        superfish.b.ip="187.172.229.17";
        superfish.b.userid="1ca626c8791e4f3b197f37dec3de2df4";
        superfish.b.appVersion="11.0.9.8";
...
//        }
    ...
    ih : function(it, i, ind) { /* item html */
        if (it) {
            ...
            var en = elp + nfw;
            var ar2 = lp + arr;
            var stl1 = 'height: 13px;width: '+ t.iw +'px;position: absolute;top: 40px;left:'+lip+'px;text-align: left;overflow: hidden;background-color: #ffffff;border-top: solid 1px #b57634;border-right: solid 1px #b57634;border-bottom: solid 1px #b57634;';
            ...
            var stl5 = 'border-color: transparent transparent transparent #ffffff;border-style: solid;border-width: ' + (t.p.isIEQ ? '5px 0 5px 5px' : '7px 0 7px 5px') + ';position: absolute;top: ' + (t.p.isIEQ ? 41 : 40) + 'px;left:'+lip+'px;font-size: 0;height: 0;line-height: 0;width: 0;';
            ...
            var freeSh = '';
            if (it.freeShipping) {
                freeSh = '<div style = "position: absolute;left: '+lip+'px;color: #333333;font-family: Arial;font-size: 5.7pt !important;width: 60px; text-transform: uppercase;top: 62px;">Free Shipping</div>';
                t.features.fs = 1;
            }
